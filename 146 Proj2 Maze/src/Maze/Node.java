...
public class Node {
	...
	void setConnectedNeighbor(int NeighborsIndex) {
		connectedNeighbors.add(Neighbors.get(NeighborsIndex)); // We add from list of neighbors our connected neighbors
																// based on NeighborsIndex, the index of our neighbors
